...
class AudioScpReader(collections.abc.Mapping):
    ...
    def __getitem__(self, key):
        ...
        if self.normalize:
            ...
            array, rate = librosa.core.load(wav, sr=24000)
            array -= array.min()
            array *= 2.0/array.max()
            array -= 1.0
        else:
            array, rate = librosa.core.load(x, sr=24000)
        """
        array, rate = librosa.core.load(wav, sr=24000)
