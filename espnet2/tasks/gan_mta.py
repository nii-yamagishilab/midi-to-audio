...
from espnet2.gan_mta.espnet_model import ESPnetGANTTSModel
from espnet2.gan_mta.joint import JointText2Wav
...
class GANMTATask(AbsTask):
    """GAN-based midi-to-audio task."""
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            help="The steps in the gan training",
        )
        parser.add_argument(
    ...
    def optional_data_names(
        ...
        if not inference:
            ...
            # Inference mode
            retval = ("spembs", "sids", "audio", "durations", "pitch", "energy")
        return retval
    ...
    def build_optimizers(
        ...
        if model.tts.use_discriminator:
